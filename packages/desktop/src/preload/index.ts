...
const bridge = {
  ...
  host: {
    ...
    vcs: {
      snapshot: none("host.vcs.snapshot"),
      contents: object("host.vcs.contents"),
      diff: object("host.vcs.diff"),
      log: object("host.vcs.log"),
      refs: none("host.vcs.refs"),
      revert: object("host.vcs.revert"),
      stage: object("host.vcs.stage"),
      commit: object("host.vcs.commit"),
      createBranch: object("host.vcs.createBranch"),
      push: object("host.vcs.push"),
      createPullRequest: object("host.vcs.createPullRequest"),
    },
    files: {
