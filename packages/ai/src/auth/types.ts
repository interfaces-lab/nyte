/**
 * Provider auth contract: request auth, stored credentials, the app-owned
 * credential store, the injectable auth context, and the login interaction
 * surface shared by api-key and OAuth flows.
 *
