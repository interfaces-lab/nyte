/**
 * Time-ordered UUIDv7 generator with a monotonic sequence, used for message and session ids.
 *
 * Based on https://github.com/earendil-works/pi/blob/dev/packages/ai/src/utils/uuid.ts
