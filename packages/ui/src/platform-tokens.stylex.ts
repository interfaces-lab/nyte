...
export const colorDefaults = {
  ...
  "--june-color-surface": "light-dark(#fcfcfc, #070707)",
  "--june-color-surface-foreground": "light-dark(#141414, #fcfcfc)",
  "--june-color-popover": "light-dark(#fcfcfc, #181818)",
  "--june-color-popover-foreground": "light-dark(#141414, #fcfcfc)",
  "--june-color-command-background": "#181818",
  "--june-color-command-border": "#f0f0f01f",
  "--june-color-command-divider": "#f0f0f014",
  "--june-color-command-scrim": "#14141480",
  ...
  "--june-color-secondary": "light-dark(#77777717, #7777772c)",
  "--june-color-secondary-hover": "light-dark(#7777772b, #77777752)",
  "--june-color-secondary-foreground": "light-dark(#141414, #fcfcfc)",
  ...
  "--june-color-accent": "light-dark(#7777772b, #77777752)",
  "--june-color-accent-foreground": "light-dark(#141414, #fcfcfc)",
  ...
  "--june-color-input": "light-dark(#14141426, #fcfcfc26)",
  ...
  "--june-color-sidebar-foreground": "light-dark(#141414, #fcfcfc)",
  "--june-color-sidebar-accent": "light-dark(#7777772b, #77777752)",
  "--june-color-sidebar-accent-foreground": "light-dark(#141414, #fcfcfc)",
  "--june-color-sidebar-border": "light-dark(#14141426, #fcfcfc26)",
...
export const elevationDefaults = {
  "--june-elevation-field":
    "0 4px 12px -1px light-dark(#00000014, #00000000), 0 2px 4px -2px light-dark(#0000000f, #00000000), 0 0 0 1px light-dark(#e4e4e40a, #e4e4e400)",
  "--june-elevation-menu":
  ...
  "--june-elevation-command":
    "inset 0px 0px 4px 0px #ffffff0d, 0px 0px 3px 0px #0000001f, 0px 16px 24px 0px #0000000f",
} as const;
