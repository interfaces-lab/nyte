...
| Entry                 | Imports                                                                                                                                                                                                |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `@nyte-ai/core`       | `createNyte`, the wire data types, `MAIN`, `DEFAULT_LANDING`, `CursorExpired`, the views, and what a host needs to compose. The operation table, envelopes, and SSE codec stay in `@nyte-ai/protocol`. |
