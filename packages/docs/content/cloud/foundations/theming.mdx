...
Override on an ancestor. The app root is the right place, and a preview container works too, which
is how the examples on this site are themed independently of the docs chrome.
