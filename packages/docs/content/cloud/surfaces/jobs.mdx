...
- A task may select an exact [subagent model](/cloud/surfaces/model-picker#subagent-models).
  Omitting it uses the task default. An unavailable explicit choice or default fails without
  substitution.
