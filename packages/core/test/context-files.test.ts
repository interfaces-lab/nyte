...
describe("context files", () => {
  test("prefers AGENTS.override.md over AGENTS.md over CLAUDE.md per directory", () => {
    const root = tempDir();
  ...
  test("collects global dir first, then ancestors outermost-first, cwd last", () => {
    const root = tempDir();
  ...
  test("strips a BOM and skips directories named like candidates", () => {
    const root = tempDir();
