...
Use your configured architect runners from `~/.agents/model-roles.md` when present; otherwise use the session model. Prefer distinct model families or effort tiers when configured; otherwise vary the prompt/lens instead.
